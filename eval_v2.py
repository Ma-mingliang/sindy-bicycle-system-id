"""Evaluate v2 MBPO-SAC model against LQR-only baseline."""
...
class MeijaardAttitudeEnv:
    ...
    def step(self, action):
        ...
        return self._get_obs(), 0, done, {'tracking_err': abs(new_dis_angle)}
...
def main():
    ...
    checkpoint = torch.load('D:/系统辨识作业/sindy_bicycle/mbpo_sac_v2.pt',
                            map_location=device)
