"""Canonical 7D model interfaces - GP, SINDy, base class."""
import numpy as np
...
class GPModel(BaseModel):
    """Standard GP model - one GP per state dimension for 7D."""
...
class SINDyModel(BaseModel):
    """SINDy polynomial regression model for 7D."""
